...
export default function ExampleUsage({
  ...
  return <div className="grid gap-4">{productCatalog}{platformCatalog}{!productCatalog && !platformCatalog && <div className="rounded-2xl border border-dashed border-gray-200 p-10 text-center text-sm text-gray-400"><Package size={22} className="mx-auto mb-2" />Каталог пока пуст.</div>}</div>;
}
