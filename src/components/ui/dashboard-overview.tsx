...
function CatalogField({ label, children }: { label: string; children: ReactNode }) {
  return <div className="directory-glass-block directory-glass-block--subtle min-w-0 rounded-xl px-3 py-2"><span className="block text-[9px] font-bold uppercase tracking-[.12em] text-gray-400">{label}</span><div className="mt-0.5 min-w-0 truncate text-xs font-semibold text-gray-800">{children}</div></div>;
}
